...
def is_known():
    ...
    unknown_words.to_csv('words_to_learn.csv')
    next_card()
...
unknown_button = Button(image=cross_mark_image, highlightthickness=0, bg=BACKGROUND_COLOR, relief="flat", command=is_known)
